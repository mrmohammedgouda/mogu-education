...
app.get('/', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <!-- 📝 ملاحظة: لتعديل هذا القسم، غيّر النصوص أعلاه:
             - السطر الذي يحتوي على <h1>: العنوان الرئيسي
             - السطر الذي يحتوي على "Trusted Accreditation": العنوان الفرعي
             - الفقرة التالية: الوصف التفصيلي
             - نصوص الأزرار: "Verify Certificate" و "Our Services"
        -->
